      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-white/60 max-w-2xl mx-auto text-sm">
            Choose the perfect plan to accelerate your fitness journey. Note: Prices are marked as placeholders for this demo.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
          {plans.map((plan, idx) => (
            ...
            >
              {plan.highlighted && (
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gold text-black font-heading tracking-widest text-sm px-4 py-1 rounded-full uppercase">
                  Most Popular
                </div>
              )}
